  ...
  <div>
    ...
    <Navbar />
      <div class="dashboard-main-body">
        ...
        <div class="mt-24">
          <IncomeHeadTable @edit-item="openEditSidebar" />
        </div>
      </div>
...
import Breadcrumb from '@/components/accounts/incomeHead/Breadcrumb.vue';
import IncomeHeadTable from '@/components/accounts/incomeHead/IncomeHeadTable.vue';
...
export default {
  ...
  setup() {
    ...
    const handleAddSubmit = () => {
      console.log('Add Income Head:', addForm.value);
      // Here you would typically make an API call to add the income head
      closeSidebar();
    };

    const handleEditSubmit = () => {
      console.log('Edit Income Head:', editForm.value);
      // Here you would typically make an API call to update the income head
      closeSidebar();
    };
