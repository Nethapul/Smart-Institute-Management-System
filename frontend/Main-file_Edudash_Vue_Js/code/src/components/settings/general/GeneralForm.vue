    ...
    <div class="card-body">
      <form action="#" @submit.prevent>
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="mb-20">
              <label for="country" class="form-label fw-semibold text-primary-light text-sm mb-8">Country <span
          ...
          <div class="row gy-4">
            <div class="col-md-6">
              <label for="imageUpload" class="form-label fw-semibold text-secondary-light text-md mb-8">Logo <span
                  class="text-secondary-light fw-normal">(140px X 140px)</span></label>
              <input type="file" class="form-control radius-8" id="imageUpload" @change="previewImage($event, 'previewImage1')">
              <div class="avatar-upload mt-16">
                <div class="avatar-preview style-two">
                  <div id="previewImage1" class="image-preview"></div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <label for="imageUploadTwo" class="form-label fw-semibold text-secondary-light text-md mb-8">Logo <span
                  class="text-secondary-light fw-normal">(140px X 140px)</span></label>
              <input type="file" class="form-control radius-8" id="imageUploadTwo" @change="previewImage($event, 'previewImage2')">
              <div class="avatar-upload mt-16">
                <div class="avatar-preview style-two">
                  <div id="previewImage2" class="image-preview"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      if (file) {
        ...
        reader.onload = (e) => {
          ...
          if (previewElement) {
            ...
            // Simple fade in effect using CSS/JS
            setTimeout(() => {
                ...
                const timer = setInterval(function () {
                    ...
                    previewElement.style.opacity = op;
                    previewElement.style.filter = 'alpha(opacity=' + op * 100 + ")";
                    op += op * 0.1;
                }, 10);
            }, 10);
          }
