  ...
  <div class="card h-100">
    ...
    <div class="card-body p-20">
      <div class="row gy-3">
        <div class="col-sm-6">
          <div class="">
            <label for="docName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Doc Name
            </label>
            <input type="text" class="form-control" id="docName" placeholder="Enter Doc Name">
          </div>
        </div>
        <div class="col-sm-6">
          <div class="">
            <label class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Guardian Photo <span
