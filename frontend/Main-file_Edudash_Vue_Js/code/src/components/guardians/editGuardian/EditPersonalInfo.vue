            ...
            <div class="row gy-3">
                <div class="col-xl-4 col-sm-6">
                    <div class="">
                        ...
                        <select id="guardianType" class="form-control form-select" v-model="form.guardianType">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="">
                        ...
                        <input type="text" id="guardianName" class="form-control" placeholder="Enter guardian name"
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="">
                        ...
                        <input type="text" id="guardianAddress" class="form-control"
                            placeholder="Enter guardian address" v-model="form.address">
                    </div>
                </div>
                <div class="col-xl-4 col-sm-6">
                    <div class="">
