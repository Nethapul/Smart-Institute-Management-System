<template>
    <div class="modal fade" id="deleteFeesGroupModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog modal-dialog-centered max-w-340-px">
            <div class="modal-content radius-16 bg-base">
                <div class="modal-body pt-32 px-36 pb-24 text-center">
                    ...
                    <h6 class="text-lg fw-semibold text-primary-light mb-0">Are you sure you want to delete this fees group?</h6>
