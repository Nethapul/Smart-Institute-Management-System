                    ...
                    <table class="table bordered-table mb-0 data-table" id="dataTable">
                        ...
                        <tbody>
                            <tr v-for="(cls, index) in classes" :key="index">
                                ...
                                <td>{{ cls.section }}</td>
                                <td>
                                    <span :class="cls.status === 'Active' ? 'bg-success-100 text-success-600' : 'bg-danger-100 text-danger-600'" class="px-24 py-4 radius-4 fw-medium text-sm">
                                        {{ cls.status }}
                                    </span>
                                </td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                            ...
                                            <li>
                                                <button type="button"
                                                    ...
                                                    @click="$emit('openEditSidebar', cls)">
        ...
        <div class="modal-dialog modal-sm modal-dialog modal-dialog-centered max-w-340-px">
            <div class="modal-content radius-16 bg-base">
                <div class="modal-body pt-32 px-36 pb-24 text-center">
                    ...
                    <h6 class="text-lg fw-semibold text-primary-light mb-0">Are your sure you want to Delete this class?</h6>
...
export default {
    ...
    setup() {
        ...
        const classes = ref([
            { id: 1, name: 'Class 1', section: 'A, B, C, D', status: 'Active' },
            { id: 2, name: 'Class 2', section: 'A, B, C, D', status: 'Inactive' },
            { id: 3, name: 'Class 3', section: 'A, B, C, D', status: 'Active' },
            { id: 4, name: 'Class 4', section: 'A, B, C, D', status: 'Inactive' },
            { id: 5, name: 'Class 4', section: 'A, B, C, D', status: 'Active' },
            { id: 6, name: 'Class 5', section: 'A, B, C, D', status: 'Inactive' },
            { id: 7, name: 'Class 6', section: 'A, B, C, D', status: 'Active' },
            { id: 8, name: 'Class 8', section: 'A, B, C, D', status: 'Inactive' },
            { id: 9, name: 'Class 9', section: 'A, B, C, D', status: 'Active' },
            { id: 10, name: 'Class 10', section: 'A, B, C, D', status: 'Inactive' },
            { id: 11, name: 'Class 11', section: 'A, B, C, D', status: 'Active' },
            { id: 12, name: 'Class 12', section: 'A, B, C, D', status: 'Inactive' },
        ]);

        const toggleAll = () => {
            if (selectAll.value) {
                selectedItems.value = classes.value.map(c => c.id);
            } else {
                selectedItems.value = [];
            }
        };
