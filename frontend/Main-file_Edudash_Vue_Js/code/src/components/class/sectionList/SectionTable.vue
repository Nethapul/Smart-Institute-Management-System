                    ...
                    <table class="table bordered-table mb-0 data-table" id="dataTable">
                        ...
                        <tbody>
                            <tr v-for="(section, index) in sections" :key="index">
                                ...
                                <td>{{ section.name }}</td>
                                <td>
                                    <span :class="section.status === 'Active' ? 'bg-success-100 text-success-600' : 'bg-danger-100 text-danger-600'" class="px-24 py-4 radius-4 fw-medium text-sm">
                                        {{ section.status }}
                                    </span>
                                </td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                            <li>
                                                <button type="button"
                                                    ...
                                                    @click="$emit('openEditSidebar', section)">
        ...
        <div class="modal-dialog modal-sm modal-dialog modal-dialog-centered max-w-340-px">
            <div class="modal-content radius-16 bg-base">
                <div class="modal-body pt-32 px-36 pb-24 text-center">
                    ...
                    <h6 class="text-lg fw-semibold text-primary-light mb-0">Are your sure you want to Delete this section?</h6>
...
export default {
    ...
    setup() {
        ...
        const toggleAll = () => {
            if (selectAll.value) {
                selectedItems.value = sections.value.map(s => s.id);
            } else {
                selectedItems.value = [];
            }
        };
